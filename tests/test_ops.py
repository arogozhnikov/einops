...
def test_reduction_stress_imperatives():
    for backend in imp_op_backends:
        ...
        for reduction in _reductions + ('rearrange',):
            ...
            for n_axes in range(6 if 'mxnet' in backend.framework_name else (7 if 'oneflow' in backend.framework_name else (9 if 'paddle' in backend.framework_name else 11))):
